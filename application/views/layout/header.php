            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?php echo base_url('master/produk'); ?>">Produk</a>
                        <a class="collapse-item" href="<?php echo base_url('master/kategori'); ?>">Karegori</a>
                    </div>
                </div>
            </li>
